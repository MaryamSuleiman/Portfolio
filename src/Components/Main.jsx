    ...
    <div className='portfolio-container'>
      ...
      <div className='portfolio-icons'>
           <div className='portfolio-icon'>
               <GithubLogo size={35} weight="thin" color='#cec7c1' />
           </div>
            <div className='portfolio-icon'>
                 <InstagramLogo size={35} weight="thin" color='#cec7c1'/>
            </div>
            <div className='portfolio-icon'>
                 <FacebookLogo size={35} weight="thin"color='#cec7c1' />
             </div>
             <div className='portfolio-icon'>
                   <TwitterLogo size={35} weight="thin" color='#cec7c1'/>
             </div>
            <div className='portfolio-icon'>
                 <Envelope size={35} weight="thin"color='#cec7c1' />
            </div>
      </div>
      <>
